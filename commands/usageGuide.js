  ...
  try {
    ...
    const introRaw = `
      ...
      🔥 8. **Duy trì streak học tập mỗi ngày**
        - Mỗi khi bạn sử dụng bất kỳ lệnh nào của bot trong ngày, bot sẽ tự động cập nhật **streak ngày học liên tiếp** và thông báo khi bạn giữ được chuỗi ngày đều đặn.

      ---

      👉 Bạn có thể gõ \`*gioi_thieu_bot\` bất cứ lúc nào để xem lại hướng dẫn này.
    `.trim()
    await message.reply(boldify(introRaw));
